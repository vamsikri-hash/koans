...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    #ans:-  So << alters the original string rather than creating a new one.
    #The reason for this is that in ruby a += b is syntactic shorthand for a = a + b (the same goes for the other <op>= operators) which is an assignment.
